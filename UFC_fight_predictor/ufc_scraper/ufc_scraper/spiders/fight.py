...
class FightSpider(scrapy.Spider):
    ...
    def parse_fight_details(self, response):
        ...
        fight['winner'] = response.xpath('/html/body/section/div/div/div[1]/div[1]/i/text()').get()
        fight['performance_bonus'] = response.xpath('/html/body/section/div/div/div[2]/div[1]/i/img/@src').get()
        fight['weight_class'] = response.xpath('/html/body/section/div/div/div[2]/div[1]/i/text()').get()
        fight['method'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[1]/i[1]/i[2]/text()').get()
        fight['round'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[1]/i[2]/text()').getall()
        fight['time'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[1]/i[3]/text()').getall()
        fight['time_format'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[1]/i[4]/text()').getall()
        fight['referee'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[1]/i[5]/span/text()').get()
        fight['judge1'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[2]/i[2]/span/text()').get()
        fight['judge2'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[2]/i[3]/span/text()').get()
        fight['judge3'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[2]/i[4]/span/text()').get()
        fight['judge_1_score'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[2]/i[2]/text()').get()
        fight['judge_2_score'] = response.xpath('/html/body/section/div/div/div[2]/div[2]/p[2]/i[3]/text()').get()
        fight['judge_3_score'] =  response.xpath('/html/body/section/div/div/div[2]/div[2]/p[2]/i[4]/text()').get()
        fight['fighter_a_knockdowns_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[2]/p[1]/text()').get()
        fight['fighter_b_knockdowns_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[2]/p[2]/text()').get()
        fight['fighter_a_sig_strikes_landed_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[3]/p[1]/text()').get()
        fight['fighter_b_sig_strikes_landed_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[3]/p[2]/text()').get()
        fight['fighter_a_sig_strikes_attempted_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[3]/p[1]/text()').get()
        fight['fighter_b_sig_strikes_attempted_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[3]/p[2]/text()').get()
        fight['fighter_a_total_strikes_landed_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[5]/p[1]/text()').get()
        fight['fighter_b_total_strikes_landed_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[5]/p[2]/text()').get()
        fight['fighter_a_total_strikes_attempted_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[5]/p[1]/text()').get()
        fight['fighter_b_total_strikes_attempted_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[5]/p[2]/text()').get()
        fight['fighter_a_takedowns_total_landed'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[6]/p[1]/text()').get()
        fight['fighter_b_takedowns_total_landed'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[6]/p[2]/text()').get()
        fight['fighter_a_takedowns_attempted_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[6]/p[1]/text()').get()
        fight['fighter_b_takedowns_attempted_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[6]/p[2]/text()').get()
        fight['fighter_a_submissions_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[8]/p[1]/text()').get()
        fight['fighter_b_submissions_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[8]/p[2]/text()').get()
        fight['fighter_a_reversals_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[9]/p[1]/text()').get()
        fight['fighter_b_reversals_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[9]/p[2]/text()').get()
        fight['fighter_a_control_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[10]/p[1]/text()').get()
        fight['fighter_b_control_total'] = response.xpath('/html/body/section/div/div/section[2]/table/tbody/tr/td[10]/p[2]/text()').get()
        fight['fighter_a_sig_head_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[4]/p[1]/text()').get()
        fight['fighter_b_sig_head_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[4]/p[2]/text()').get()
        fight['fighter_a_sig_head_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[4]/p[1]/text()').get()
        fight['fighter_b_sig_head_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[4]/p[2]/text()').get()
        fight['fighter_a_sig_body_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[5]/p[1]/text()').get()
        fight['fighter_b_sig_body_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[5]/p[2]/text()').get()
        fight['fighter_a_sig_body_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[5]/p[1]/text()').get()
        fight['fighter_b_sig_body_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[5]/p[2]/text()').get()
        fight['fighter_a_sig_leg_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[6]/p[1]/text()').get()
        fight['fighter_b_sig_leg_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[6]/p[2]/text()').get()
        fight['fighter_a_sig_leg_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[6]/p[1]/text()').get()
        fight['fighter_b_sig_leg_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[6]/p[2]/text()').get()
        fight['fighter_a_sig_distance_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[7]/p[1]/text()').get()
        fight['fighter_b_sig_distance_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[7]/p[2]/text()').get()
        fight['fighter_a_sig_distance_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[7]/p[1]/text()').get()
        fight['fighter_b_sig_distance_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[7]/p[2]/text()').get()
        fight['fighter_a_sig_clinch_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[8]/p[1]/text()').get()
        fight['fighter_b_sig_clinch_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[8]/p[2]/text()').get()
        fight['fighter_a_sig_clinch_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[8]/p[1]/text()').get()
        fight['fighter_b_sig_clinch_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[8]/p[2]/text()').get()
        fight['fighter_a_sig_ground_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[9]/p[1]/text()').get()
        fight['fighter_b_sig_ground_landed_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[9]/p[2]/text()').get()
        fight['fighter_a_sig_ground_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[9]/p[1]/text()').get()
        fight['fighter_b_sig_ground_attempted_total'] = response.xpath('/html/body/section/div/div/table/tbody/tr/td[9]/p[2]/text()').get()
        yield fight
